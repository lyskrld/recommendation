...
import setproctitle
import dataset
from model import IHGCN,IHGCN_Info
...
def main():
    ...
    for lr, decay, message_dropout, node_dropout \
        ...
        info = IHGCN_Info(64, decay, message_dropout, node_dropout, 2)
        model =IHGCN(info, assist_data, graph, device, pretrain=None).to(device)
